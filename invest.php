      ...
      <div class="row" style="height: 100%;">
            <div class="dashboard col-lg-12">
                <div class="dashboard_border col-lg-push-1 col-lg-10">
                    ...
                    <div class="dashboard_h1 col-lg-12 animated bounceInLeft"><h1 style="font-family: gabriola; font-size: 19px; margin-bottom: -6px;">Deposit</h1></div>
                    <div class="ac_wi_ref animated zoomIn">
                        ...
                        <form action="https://www.investorsstate.com/next_step.php" method="get">
                            <label>
                              <input type="radio" name="banktype" value="betcion" />
                              <img src="image/betcion.png" width="100" height="50">
                            </label>
                            <label>
                              <input type="radio" name="banktype" value="neteller" />
                              <img src="image/neteller.png" width="100" height="50">
                            </label>
                            <label>
                              <input type="radio" name="banktype" value="skrill" />
                              <img src="image/skrill.png" width="100" height="50">
                            </label>
                            <label>
                              <input type="radio" name="banktype" value="payeer" />
                              <img src="image/payeer.png" width="100" height="50">
                            </label>
                            <label>
                              <input type="radio" name="banktype" value="perfetmoney" />
                        ...
                        <div class="dashboard_h1 animated bounceInLeft col-lg-12"><h1 style="font-family: gabriola; font-size: 19px; margin-bottom: -6px;">CHOOSE purchase</h1></div>
                        <div class="ac_wi_ref animated zoomIn">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4" style="margin-top: 20px;">
                                <input type="submit" name="opendeposit" value="open Deposit"/>
                            </div>
                            </form>
                        </div>
                    </div>
...
Thank you for your trust in us. We trying hardly to be in good relationship with you to now more information you can visit </span><a href="#">about us</a>
      ...
      <div class="container-fluid">
          <div class="row">
              <div class="dashboard_footer col-lg-12" style=" height: 200px;  position: absolute; top: 100%; width: 100%;">
