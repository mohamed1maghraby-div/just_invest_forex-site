            ...
            <div class="col-lg-push-1 col-lg-5 cirtificat">
                ...
                <div class="col-lg-6 cirtificat_explane">
                    <div style="font-size: 35px;">
                            <span style="font-family: gabriola; font-size:47px; font-weight-weight: 600;">COMPANY investors state</span>
                        </div>
                    <div style="margin-top: 20px; color: #999;  font-size: 15px;
    letter-spacing: .7px;
">
                            <span>Since 2017, the company investors state has been engaged in the development of investe deposits and the production and marketing of crude investe from the EG.</span>
                    </div>
                    <div style="margin-top: 20px; color: #999;  font-size: 15px;
    letter-spacing: .7px;
">
                            <span>investors state also works together with individuals who want to invest in our company's development.</span>
                        </div>
                    ...
                    <div style="margin-top: 20px; color: #999; font-size: 15px; letter-spacing: .7px;">
                            <span>11 April 2017 due to a large influx of investors, the head office of investors state decided to register a subsidiary company investors state, which will be fully focused on managing the financial flows of our investors.</span>
                    </div>
                   <div class="col-lg-push-4 col-lg-5"><h1 style="font-family: gabriola; font-size:47px; font-weight-weight: 600;">our history</h1></div><div class="clearfix"></div>
                    <div class="col-lg-6">
