        ...
        <div class="row">
          <div class="faq">
            <div class="col-lg-6">
                ...
                <div class="faq_question">
                    <P>IS it really possible to earn guaranteed monthly income?</P>
                </div>
                <div class="faq_question" style="margin-top: 65px;">
                    <P>How do you minimize risk?</P>
                </div>
                <div class="faq_question" style="margin-top: 74px;">
                    <P>Is personal information published in the public domain?</P>
                </div>
              </div>
              <div class="col-lg-6">
              <div class="faq_anwer">
                  <div class="arrawleft"></div>
                    <P>Complete the simple registration procedure, make a deposit, and start making a profit every day.</P>
                </div>
                  <div class="faq_anwer">
                      <div class="arrawleft_1"></div>
                    <P>With justinveste you can feel totally safe and not worry about the security of the funds you've invested.</P>
                </div>
                  <div class="faq_anwer">
                      <div class="arrawleft_2"></div>
                    <P>Balance and conservative handling of the investment portfolio allows for intelligent control of the funds and the ability to adhere to a successful, ongoing investment strategy. To accelerate your return on investment, use our affiliate program.</P>
                </div>
                  <div class="faq_anwer">
                      <div class="arrawleft_3"></div>
                    <P>Our company publishes only that data which is connected with your business activity based on your investment activities. Disclosure of any of your personal or contact information is absolutely forbidden.</P>
                </div>
         ...
         <div class="container-fluid">
          <div class="row">
              ...
              <div class="sidebar">
                ...
                <span class="sidebar_text" style="font-family: gabriola; font-size: 22px; bottom: -17px;">Register/Login </span>
                  </div>
              </div>
...
if(isset($_POST['login'])){
    if(empty($loginusername) || empty($loginpassword)){
        ...
        $select_c = "select * from customers where username = '$loginusername' AND password = '$loginpassword' ";
...
<?php // singup value
    ...
    if(isset($_POST['register'])){
        if(empty($username) || empty($password) || empty($email) || empty($country)){
            ...
            $insert_c = "insert into customers(username,password,email,country,referral) values('$username','$password','$email','$country','$referral')";
...
?>
                  <div class="login_form">
                        ...
                        <form action="" method="post">
                            ...
                            <input type="checkbox" name="" value=""/> <span>accept our terms and conditions</span><br/>
